...
// std::map<std::string,std::string> in shared memory.
typedef std::map<shm_string, shm_string, std::less<shm_string>,
	stldb::scope_aware_allocator<
...
int test_perf3()
{
	...
	// test database
	TestDatabase<fixed_managed_mapped_file,MapType> db("test_perf3");
